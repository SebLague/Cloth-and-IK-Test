...
public static class Visualizer
{
	...
	public static void DrawLine(Vector3 start, Vector3 end, float thickness)
	{
		...
		CreateVisualElement(cylinderMesh, centre, rot, scale);
	}

	public static void DrawPolyLine(float thickness, params Vector2[] points)
	{
		Mesh mesh = CreateOrRecycleMesh();
		PolyLine.CreateLine(points, thickness, ref mesh);
